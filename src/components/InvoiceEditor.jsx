...
const THEMES = {
  ...
  // BCA — yellow header, bold black text throughout
  bold: {
    darkHeader: false,
    docCls: 'flex-1 bg-white rounded-xl shadow-invoice overflow-hidden relative min-w-0',
    headerCls: 'bg-yellow-400 px-7 pt-7 pb-6',
    logoMark: 'text-black font-black text-xl leading-none',
    coName: 'text-black text-xl font-black tracking-tight',
    badge: 'w-6 h-6 rounded-lg bg-black flex items-center justify-center text-[10px] font-bold text-yellow-400 flex-shrink-0',
    ...
    sectionLabel: 'text-[10px] font-bold uppercase tracking-widest text-yellow-600 mb-2',
    box: 'border-2 border-yellow-300 rounded-xl p-3 min-h-[90px] bg-yellow-50/50',
    theadRow: 'border-b-[3px] border-black',
    theadTh: 'text-black',
    grandTotal: 'text-black',
    statsTotal: 'text-yellow-600',
